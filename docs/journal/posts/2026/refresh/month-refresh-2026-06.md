---
title: Monthly Refresh 2026.06
date: 2026-06-28
description: practice plus feedback is the key
categories:
  - refresh
...
- The prod release itself was smooth, but issues still surfaced afterwards, because the test env and the prod env (running 24/7) differ.
  - And I didn't have enough context or capability to write tools and investigate the issues efficiently.
...
- k3s + tailscale + traefik turned out to be a better solution than my previous k3s + tailscale-subrouter + `svc`: no more latency and everything runs smoother. I deployed even more services to my k3s — now 50+ pods running 24/7.
