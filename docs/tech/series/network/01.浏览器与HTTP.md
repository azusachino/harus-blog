...
![](/assets/images/2022/02/SaCalobra.jpg){ .post-cover }

通过与浏览器进行简单的交互，学习网络相关的基础知识点。

## 整体预览

![ ](/assets/images/2022/02/network-preface.jfif)
...
![ ](/assets/images/2022/02/network-http-elements.jfif)
...
![ ](/assets/images/2022/02/network-http-request.png)

![ ](/assets/images/2022/02/network-http-response.png)

#### HTTP 方法清单

![ ](/assets/images/2022/02/network-http-methods.jfif)
...
![ ](/assets/images/2022/02/network-http-ip.jfif)
...
![ ](/assets/images/2022/02/network-http-dns-resolve.jfif)

### DNS 服务器的层层接力

![ ](/assets/images/2022/02/network-http-dns-search.jfif)
...
![ ](/assets/images/2022/02/network-http-socket.jfif)
