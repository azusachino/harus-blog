...
![](/assets/images/2022/02/WinterOlymics.jpg){ .post-cover }
...
![ ](/assets/images/2022/02/network-tcp-abstract-layer.jfif)
...
![ ](/assets/images/2022/02/network-tcp-socket.jfif)

### Socket 使用示例

![ ](/assets/images/2022/02/network-tcp-socket-usage.jfif)
...
![ ](/assets/images/2022/02/network-tcp-header.jfif)

在连接、收发、断开等各个阶段中，每次客户端和服务端之间进行通信时，都需要提供这些控制信息。

### TCP/IP 包抽象示例

![ ](/assets/images/2022/02/network-tcp-package.jfif)
...
![ ](/assets/images/2022/02/network-tcp-package-mtu.jfif)
...
![ ](/assets/images/2022/02/network-tcp-connect.jfif)
